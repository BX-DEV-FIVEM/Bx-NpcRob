...
local function policeAlert()
    ...
    if alertLuck <= Config.PoliceAlertProbability then  
        TriggerServerEvent('BX-NpcRob:server:policeAlert', GetEntityCoords(PlayerPedId()))
    end    
end
...
RegisterNetEvent('BX-NpcRob:client:policeAlert', function (pos)
